...
public:
    static bool loadAssets() {
        ...
        Animation* playerAnim =  assets.loadAnimation(bb::ANIMID_PLAYER, bb::rogueRes.name,{ 0, 0, bb::ASSETS_TILE_SIZE, bb::ASSETS_TILE_SIZE });
        if (!playerAnim) return false;

        Animation* enemyAnim = assets.loadAnimation(bb::ANIMID_ENEMY, bb::monsterRes.name, { 0, 0, bb::ASSETS_TILE_SIZE, bb::ASSETS_TILE_SIZE });
